...
export default function LoadingSkeleton() {
  return (
    <Card className="relative px-2 h-175 w-150 max-w-lg mx-auto overflow-hidden bg-linear-to-br from-background via-background/95 to-rose-500/5 backdrop-blur-lg shadow-2xl rounded-3xl border border-rose-500/10">
